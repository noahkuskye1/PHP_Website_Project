   ...
   <!-- title of page -->
    ...
    <body onload="startTime()">   
        ...
        <div style="background-color:#2b86b0;
          ...
          <br>
          <h3>This page is the results from a written form</h3>
          <br>
          <br>
          <div class="font">
          <?php
            ...
            $m = $_POST["movie"];
            $n = $_POST["number"];
            if (filter_var($s, FILTER_SANITIZE_STRING)) {
              echo "Here is your results:<b>".$s."</b>";
            } else {
              echo "This is not valid data.";
            }
            echo "<br>";
            echo "<br>";
            if (filter_var($m, FILTER_SANITIZE_STRING)) {
              echo "Here is your results:<b>".$m."</b>";
            } else {
              echo "This is not valid data.";
            }
            echo "<br>";
            echo "<br>";
            if (filter_var($n, FILTER_VALIDATE_INT, FILTER_SANITIZE_NUMBER_INT)) {
              echo "Here is your results:<b>".$n."</b>";
            } else {
              echo "This is not valid data.";
            }
          ?>
